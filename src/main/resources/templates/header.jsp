...
<head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script type="text/javascript" src="/scripts/main/base/select.js"></script>
    ...
    <div class="container">
        ...
        <nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class=""><a href="/logout?admin=user">退出登陆</a></li>
                <li class=""><a href="/user/$!{user.id}/">$!{user.UserName}</a></li>
                <input id="log" style="display: none" value="$!{user.UserName}">
                #else
